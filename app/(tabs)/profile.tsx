      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.healthScoreCard}>
            <HealthScoreMeter score={87} size={140} />
            <View style={styles.healthScoreInfo}>
              <Text style={styles.healthScoreTitle}>Your Health Score</Text>
              <Text style={styles.healthScoreDescription}>
                Based on your recent tests and consultations, your health is in excellent condition.
              </Text>
              <View style={styles.healthSuggestions}>
                <Text style={styles.suggestionTitle}>Recommendations:</Text>
                <Text style={styles.suggestionText}>• Continue regular exercise</Text>
                <Text style={styles.suggestionText}>• Schedule annual checkup</Text>
                <Text style={styles.suggestionText}>• Maintain balanced diet</Text>
              </View>
            </View>
          </View>
        </View>
